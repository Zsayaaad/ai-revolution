                ...
                {["Twitter", "LinkedIn", "GitHub"].map((social) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center 
                               text-gray-400 hover:text-white hover:bg-primary hover:border-primary 
                               transition-all duration-300 transform hover:-translate-y-1"
                  >
                    <span className="sr-only">{social}</span>
                    {/* Simple Geometric Placeholder Icons */}
                    <svg
                    ...
                    >
                      {social === "Twitter" && (
                        <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-12.7 12.5S.2 5.3 7.8 4.5c2.1-.1 3.2.4 3.2.4l1.4-2.5z" />
                      )}
                      {social === "LinkedIn" && (
                        <>
